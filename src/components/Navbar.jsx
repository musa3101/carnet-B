      ...
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            {/* Quick Ask AI Professor Trigger */}
            <button
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-xl text-xs bg-[#101622] border border-slate-800 text-slate-300 hover:text-white hover:border-sky-500/50 transition-all group shadow-sm shrink-0"
            >
              ...
              <kbd className="hidden md:inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-mono text-slate-400 bg-slate-900 rounded border border-slate-700">
                ⌘K
              </kbd>
            </button>
            ...
            <div 
              ...
              className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#101622] border border-slate-800 cursor-pointer hover:border-slate-700 transition-colors"
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-850 transition-colors border border-transparent hover:border-slate-800 shrink-0"
